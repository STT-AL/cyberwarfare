...
Secara tradisional, peperangan berlangsung di empat domain fisik: **Darat  जमीन, Laut 🌊, Udara ✈️, dan Antariksa 🛰️**. Namun, dengan digitalisasi global, komunitas militer dan strategis di seluruh dunia sekarang secara resmi mengakui ***Cyberspace* (Ruang Siber)** sebagai **domain peperangan kelima**.
...
```mermaid
timeline
    title Evolusi Konflik Siber
    1980s : Kelahiran & Eksperimen
        : 1988 - Morris Worm
        : Insiden siber skala besar pertama, melumpuhkan ~10% internet. Menunjukkan potensi disrupsi global.
    1990s : Era Spionase Awal
        : 1998 - Moonlight Maze
        : Kampanye spionase siber jangka panjang pertama yang terdeteksi, menargetkan Pentagon & NASA. Diduga berasal dari Rusia.
        : 1999 - Perang Kosovo
        : Penggunaan serangan siber (DDoS, defacement) yang terintegrasi dengan kampanye militer konvensional.
    2000s : Eskalasi & Serangan Skala Nasional
        : 2003 - Titan Rain
        : Kampanye spionase masif yang menargetkan kontraktor pertahanan AS. Diduga berasal dari Tiongkok.
        : 2007 - Serangan Siber Estonia
        : Serangan siber pertama yang melumpuhkan infrastruktur digital sebuah negara (perbankan, pemerintah). Titik balik dalam sejarah.
        : 2008 - Perang Rusia-Georgia
        : Serangan siber dikoordinasikan dengan invasi darat untuk menciptakan kekacauan dan mendukung operasi kinetik.
    2010s : Era Senjata Siber & Sabotase Fisik
        : 2010 - Stuxnet Ditemukan
        : Senjata siber pertama yang berhasil menyebabkan kerusakan fisik yang signifikan (sabotase sentrifugal nuklir Iran).
        : 2015 - Serangan Jaringan Listrik Ukraina
        : Serangan siber pertama yang terkonfirmasi berhasil memadamkan jaringan listrik sebuah negara.
        : 2016 - Intervensi Pemilu AS
        : Operasi pengaruh dan peretasan skala besar yang bertujuan untuk memanipulasi proses demokrasi.
    2020s : Perang Hibrida & Norma Baru
        : 2022 - Invasi Rusia ke Ukraina
        : Integrasi penuh operasi siber (serangan satelit Viasat, wiper malware) dengan perang kinetik skala besar.
```
...
```mermaid
graph LR
    subgraph "Operasi Siber Militer/CSO"
        DCO[Operasi Siber Defensif - DCO]
        OCO[Operasi Siber Ofensif - OCO]
        IO[Operasi Informasi - IO]
    end

    subgraph "DCO: Melindungi Jaringan Sendiri"
        DCO1[Perlindungan Jaringan DoD]
        DCO2[Pertahanan Infrastruktur Kritis Nasional]
        DCO3[Perburuan Ancaman/Threat Hunting]
        DCO4[Respons Insiden]
    end

    subgraph "OCO: Memproyeksikan Kekuatan"
        OCO1[ISR Siber/Intelijen]
        OCO2[Persiapan Medan Tempur Siber]
        OCO3[Serangan Siber terhadap Musuh]
        OCO4[Dukungan Siber untuk Operasi Kinetik]
    end

    subgraph "IO: Mempengaruhi Domain Kognitif"
        IO1[Operasi Psikologis/PSYOP]
        IO2[Penipuan Militer/MILDEC]
        IO3[Operasi Keamanan/OPSEC]
        IO4[Disinformasi/Kontra-Disinformasi]
    end

    DCO --- DCO1 & DCO2 & DCO3 & DCO4
    OCO --- OCO1 & OCO2 & OCO3 & OCO4
    IO --- IO1 & IO2 & IO3 & IO4
```

#### **a. Operasi Siber Defensif (DCO) - Perisai 🛡️**
...
#### **b. Operasi Siber Ofensif (OCO) - Pedang ⚔️**
